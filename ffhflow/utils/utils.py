...
def load_rendered_pcd(path, k_down=1, convert_to_centroid=False):
    ...
    if convert_to_centroid:
        ...
        rendered_pc.transform(camera_to_world)
        rendered_pc.translate(-1*rendered_pc.get_center())
...
# batch*n
def normalize_vector(v, return_mag=False,device=False):
    batch = v.shape[0]
